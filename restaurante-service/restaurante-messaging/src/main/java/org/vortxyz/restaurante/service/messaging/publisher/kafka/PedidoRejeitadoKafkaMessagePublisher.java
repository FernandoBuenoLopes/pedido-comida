...
@Slf4j
@Component
public class PedidoRejeitadoKafkaMessagePublisher implements PedidoRejeitadoMessagePublisher {
    ...
    public PedidoRejeitadoKafkaMessagePublisher(RestauranteMessagingDataMapper restauranteMessagingDataMapper,
    ...
    @Override
    public void publish(PedidoRejeitadoEvent pedidoRejeitadoEvent) {

        String pedidoId = pedidoRejeitadoEvent.getPedidoAprovacao().getPedidoId().getValue().toString();
        log.info("Recebido PedidoRejeitadoEvent para pedido com id: {}.", pedidoId);

        try {
            RestauranteAprovacaoResponseAvroModel restauranteAprovacaoResponseAvroModel = restauranteMessagingDataMapper
                    .pedidoRejeitadoEventToRestauranteAprovacaoResponseAvroModel(pedidoRejeitadoEvent);
